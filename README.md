...
2. **Basic save game preview / metadata:** If you use the Python version, and if you can
  easily obtain a picture (file) or metadata (like from json) for any saves, you can
  provide basic save-game preview by using the `BasicGameSaveGameInfo`. See
  [games/game_witcher3.py](games/game_witcher3.py) and
  [games/game_cyberpunk2077.py](games/game_cyberpunk2077.py) for more details.
